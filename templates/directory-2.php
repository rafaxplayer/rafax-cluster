...
$output .= '[su_row][su_column size="1/2" center="no" class=""]'.str_replace(array('width="600"','height="450"'),array('width="100%"','height="250"'),$row['Iframe']).'[/su_column]';
$output .= '[su_column size="1/2" center="no" class=""]';
$output .= '[su_service title="Web" icon="icon: globe" icon_color="#e5501b"]'.$row['Direccion'].'[/su_service]';
